...
export function isLifecycleEvent(e: AGUIEvent) {
  return e.type === EventType.RUN_STARTED || e.type === EventType.RUN_FINISHED || e.type === EventType.RUN_ERROR || e.type === EventType.STEP_STARTED || e.type === EventType.STEP_FINISHED
}
