...
import type { ActivitySnapshotEvent, ActivityDeltaEvent, BaseEvent, RunErrorEvent, RunFinishedEvent, RunStartedEvent, StepFinishedEvent, StepStartedEvent, TextMessageContentEvent, TextMessageEndEvent, TextMessageStartEvent, ToolCallArgsEvent, ToolCallChunkEvent, ToolCallEndEvent, ToolCallResultEvent, ToolCallStartEvent } from "@ag-ui/core";
        ...
        children: [
          {
            ...
            children: [
              { type: "text", value: "Loading results from execute step..." }
            ]
          }
        ]
      },
